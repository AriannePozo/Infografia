# Utilizando la librería de arcade
# api.arcade.academy -> Buscar en google para la documentacion de la libreria
...
def draw_flower():
    ...
    arcade.draw_circle_filled(
        SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2, 50, arcade.color.YELLOW)
